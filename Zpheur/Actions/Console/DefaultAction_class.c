...
PHP_METHOD(Console_DefaultAction, exitCode)
{
    ...
    console_default_action_object* instance = 
        ZPHEUR_ZVAL_GET_OBJECT(console_default_action_object, getThis());

    instance->common->exit_code = exit_code;
    
    zend_register_long_constant("EXIT_CODE", sizeof("EXIT_CODE") -1, 
        exit_code, CONST_CS | CONST_PERSISTENT, 51);
