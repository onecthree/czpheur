...
ZEND_MINIT_FUNCTION(Zpheur_Actions_Middleware)
{
    ...
    zend_declare_property_null(zpheur_actions_middleware_class_entry, "globals", sizeof("globals") - 1, ZEND_ACC_PUBLIC);
    zend_declare_property_null(zpheur_actions_middleware_class_entry, "middlewares", sizeof("middlewares") - 1, ZEND_ACC_PUBLIC);
    zend_declare_property_null(zpheur_actions_middleware_class_entry, "middleware_filepath", sizeof("middleware_filepath") - 1, ZEND_ACC_PUBLIC);
