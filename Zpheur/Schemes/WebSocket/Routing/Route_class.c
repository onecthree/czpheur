...
PHP_METHOD(Route, add)
{
    ...
    switch( method )
    {
        // case 7874:
        case LOCALVERB_GET: 
            websocket_method_src = "GET";
            websocket_method_len = sizeof("GET") - 1;
        break;
        // case 88814:
        case LOCALVERB_POST:
            websocket_method_src = "POST";
            websocket_method_len = sizeof("POST") - 1;
        break;
        // case 8934:
        case LOCALVERB_PUT:
            websocket_method_src = "PUT";
            websocket_method_len = sizeof("PUT") - 1;
        break;
        // case 874142:
        case LOCALVERB_PATCH:
            websocket_method_src = "PATCH";
            websocket_method_len = sizeof("PATCH") - 1;
        break;
        // case 7573809:
        case LOCALVERB_DELETE:
            websocket_method_src = "DELETE";
            websocket_method_len = sizeof("DELETE") - 1;
        break;
        case LOCALVERB_HEAD:
            websocket_method_src = "HEAD";
            websocket_method_len = sizeof("HEAD") - 1;
        break;
        // case 87921763:
        case LOCALVERB_OPTIONS:
            websocket_method_src = "OPTIONS";
            websocket_method_len = sizeof("OPTIONS") - 1;
        break;
        case LOCALVERB_WEBSOCKET:
            websocket_method_src = "WEBSOCKET";
            websocket_method_len = sizeof("WEBSOCKET") - 1;
        break;
        default:
    ...
    if(! zend_hash_str_exists(Z_ARR_P(routes), websocket_method_src, websocket_method_len) )
        php_error_docref(NULL, E_ERROR, "'%s' method are undefined", websocket_method_src);

    zval* routes_per_method = 
        zend_hash_str_find(Z_ARR_P(routes), websocket_method_src, websocket_method_len);
...
{
    char*   websocket_verb_src = NULL;
    size_t  websocket_verb_len = 0;

    ZEND_PARSE_PARAMETERS_START(1, 1)
        Z_PARAM_STRING(websocket_verb_src, websocket_verb_len)
    ZEND_PARSE_PARAMETERS_END();

    unsigned long websocket_verb_repnum =
        string_to_digits(websocket_verb_src, websocket_verb_len, LOCALVERB_WEBSOCKET);

    switch( websocket_verb_repnum )
    {
        case LOCALVERB_GET:
        case LOCALVERB_POST:
        case LOCALVERB_PUT:
        ...
        case LOCALVERB_OPTIONS:
        case LOCALVERB_WEBSOCKET:
            RETURN_LONG(websocket_verb_repnum); 
        break;
    }
...
ZEND_MINIT_FUNCTION(Zpheur_Schemes_WebSocket_Routing_Route)
{
    zend_class_entry ce;

    INIT_NS_CLASS_ENTRY(ce, "Zpheur\\Schemes\\WebSocket\\Routing", "Route", zpheur_schemes_websocket_routing_route_class_method);
    zpheur_schemes_websocket_routing_route_class_entry = zend_register_internal_class(&ce);
    zpheur_schemes_websocket_routing_route_class_entry->ce_flags |= ZEND_ACC_NO_DYNAMIC_PROPERTIES;

    zend_declare_property_null(zpheur_schemes_websocket_routing_route_class_entry, "route_filepath", sizeof("route_filepath") - 1, ZEND_ACC_PUBLIC);
    zend_declare_property_null(zpheur_schemes_websocket_routing_route_class_entry, "middleware_filepath", sizeof("middleware_filepath") - 1, ZEND_ACC_PUBLIC);

    zend_declare_property_null(zpheur_schemes_websocket_routing_route_class_entry, "routes", sizeof("routes") - 1, ZEND_ACC_PROTECTED);
    zend_declare_property_null(zpheur_schemes_websocket_routing_route_class_entry, "middlewares", sizeof("middlewares") - 1, ZEND_ACC_PUBLIC);

    zend_declare_property_null(zpheur_schemes_websocket_routing_route_class_entry, "target_method", sizeof("target_method") - 1, ZEND_ACC_PUBLIC);
    zend_declare_property_null(zpheur_schemes_websocket_routing_route_class_entry, "target_uri", sizeof("target_uri") - 1, ZEND_ACC_PUBLIC);
    zend_declare_property_null(zpheur_schemes_websocket_routing_route_class_entry, "action_class", sizeof("action_class") - 1, ZEND_ACC_PUBLIC);
    zend_declare_property_null(zpheur_schemes_websocket_routing_route_class_entry, "action_method", sizeof("action_method") - 1, ZEND_ACC_PUBLIC);

    // zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "GET", sizeof("GET") - 1, 7874);
    // zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "POST", sizeof("POST") - 1, 88814);
    // zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "PUT", sizeof("PUT") - 1, 8934);
    // zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "PATCH", sizeof("PATCH") - 1, 874142);
    // zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "DELETE", sizeof("DELETE") - 1, 7573809);
    // zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "OPTIONS", sizeof("OPTIONS") - 1, 87921763);

    zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "GET", sizeof("GET") - 1, LOCALVERB_GET);
    zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "POST", sizeof("POST") - 1, LOCALVERB_POST);
    zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "PUT", sizeof("PUT") - 1, LOCALVERB_PUT);
    zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "PATCH", sizeof("PATCH") - 1, LOCALVERB_PATCH);
    zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "DELETE", sizeof("DELETE") - 1, LOCALVERB_DELETE);
    zend_declare_class_constant_long(zpheur_schemes_websocket_routing_route_class_entry, "OPTIONS", sizeof("OPTIONS") - 1, LOCALVERB_OPTIONS);
