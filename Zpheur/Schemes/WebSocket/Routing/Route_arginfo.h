...
#ifndef H_ZPHEUR_SCHEMES_WEBSOCKET_ROUTING_ROUTE
#define H_ZPHEUR_SCHEMES_WEBSOCKET_ROUTING_ROUTE
...
zend_class_entry* zpheur_schemes_websocket_routing_route_class_entry;
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(Route_tryVerbFromString_arginfo, 0, 1, IS_LONG | IS_NULL, 0)
    ZEND_ARG_TYPE_INFO(0, websocket_verb, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
static const zend_function_entry zpheur_schemes_websocket_routing_route_class_method[] = {
